...
<body>
    ...
    <?php 
        ...
        */
        ...
        echo reverseString("Dicky Surya");
        ...
        */
        ...
        // Hapus komentar di bawah ini untuk jalankan code
        echo "palindrome(civic) =>  output : ";
        echo palindrome("civic") ; // true
        echo "palindrome(nababan) =>  output : ";
        echo palindrome("nababan") ; // true
        echo "palindrome(jambanan) =>  output : ";
        echo palindrome("jambaban"); // false
        echo "palindrome(racecar) =>  output : ";
        ...
        */
        ...
        // Hapus komentar di bawah ini untuk jalankan code
        echo "tentukan_nilai(98) =>  output : ";
        echo tentukan_nilai(98); //Sangat Baik
        echo "tentukan_nilai(76) =>  output : ";
        echo tentukan_nilai(76); //Baik
        echo "tentukan_nilai(67) =>  output : ";
        echo tentukan_nilai(67); //Cukup
        echo "tentukan_nilai(43) =>  output : ";
